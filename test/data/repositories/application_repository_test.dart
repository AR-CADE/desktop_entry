...
void main() {
  group('ApplicationRepository', () {
    ...
    group('getApplication', () {
      ...
      test('with success', () async {
        /// TEST 0
        final test0 = applicationRepository.getApplication(
          'test/data/applications/test-0.desktop',
        )!;
        expect(test0.exec, 'test');
        expect(test0.tryExec, 'test');
        expect(test0.desktopActions, null);
        ...
        /// TEST 1
        final test1 = applicationRepository.getApplication(
          'test/data/applications/test-1.desktop',
        )!;
        expect(test1.exec, 'test');
        expect(test1.tryExec, 'test');
        expect(test1.desktopActions, null);
        ...
        /// TEST 2
        final test2 = applicationRepository.getApplication(
          'test/data/applications/test-2.desktop',
        )!;
        expect(test2.exec, 'test');
        expect(test2.tryExec, 'test');
        expect(test2.desktopActions, null);
        ...
        /// TEST 3
        final test3 = applicationRepository.getApplication(
          'test/data/applications/test-3.desktop',
        )!;
        expect(test3.exec, 'ls');
        expect(test3.tryExec, null);
        expect(test3.type, 'Application');
        ...
        /// TEST 4
        final test4 = applicationRepository.getApplication(
          'test/data/applications/test-4.desktop',
        )!;
        expect(test4.exec, 'ls');
        expect(test4.tryExec, null);
        expect(test4.desktopActions, null);
        ...
        /// TEST 5
        final test5 = applicationRepository.getApplication(
          'test/data/applications/test-5.desktop',
        )!;
        expect(test5.exec, 'doesnotexist1234');
        expect(test5.tryExec, 'doesnotexist1234');
        expect(test5.desktopActions, null);
        ...
        /// TEST 6
        final test6 = applicationRepository.getApplication(
          'test/data/applications/test-6.desktop',
        )!;
        expect(test6.exec, 'test');
        expect(test6.tryExec, 'test');
        expect(test6.desktopActions, null);
      ...
      test('with parse error', () async {
        final application = applicationRepository.getApplication(
          'test/data/applications/test-7.desktop',
        );
