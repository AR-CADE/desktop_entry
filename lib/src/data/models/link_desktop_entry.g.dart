...
part of 'link_desktop_entry.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LinkDesktopEntry _$LinkDesktopEntryFromJson(Map<String, dynamic> json) =>
    LinkDesktopEntry(
      ...
      localizedComment: (json['LocalizedComment'] as Map<String, dynamic>?)
          ?.map((k, e) => MapEntry(k, e as String?)),
      localizedGenericName:
          (json['LocalizedGenericName'] as Map<String, dynamic>?)?.map(
...
Map<String, dynamic> _$LinkDesktopEntryToJson(LinkDesktopEntry instance) =>
    <String, dynamic>{
      'Type': instance.type,
